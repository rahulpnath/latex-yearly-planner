...
> Fork of [kudrykv/latex-yearly-planner](https://github.com/kudrykv/latex-yearly-planner),
> adding a Docker build so nothing has to be installed locally, and a preset for the
> [Onyx Boox Go 10.3](docs/boox-go-103.md) with an optional time-blocking layout.
...
Nothing to install but Docker, and no need to clone. See [docs/docker.md](docs/docker.md).
...
Pass `-e PLANNER_YEAR=2027`, or `-e CFG=...` for a different device or layout.
...
`cfg/boox_go_103.*.yaml` target the Onyx Boox Go 10.3 (10.3" 1872x1404 panel).
Two overlays combine with it: ruled lines instead of dots, and a Cal Newport
style time-blocking layout that moves the schedule onto a sheet of its own.
[docs/boox-go-103.md](docs/boox-go-103.md) covers the options.

```bash
docker run --rm -v "$PWD:/out" -e PLANNER_YEAR=2026 \
  ...
  -e NAME="boox_go_103.timeblock.lined.2026" planner
```

# Preview examples

### Boox Go 10.3, lined, with time blocking
<img src="examples/pictures/boox_go_103.timeblock.lined/01_annual.png" width="419"><img src="examples/pictures/boox_go_103.timeblock.lined/02_quarter.png" width="419"><img src="examples/pictures/boox_go_103.timeblock.lined/03_month.png" width="419"><img src="examples/pictures/boox_go_103.timeblock.lined/04_week.png" width="419"><img src="examples/pictures/boox_go_103.timeblock.lined/05_day.png" width="419"><img src="examples/pictures/boox_go_103.timeblock.lined/06_timeblock.png" width="419"><img src="examples/pictures/boox_go_103.timeblock.lined/07_day_notes.png" width="419"><img src="examples/pictures/boox_go_103.timeblock.lined/08_notes_index.png" width="419">

### Supernote A5X (upstream)
